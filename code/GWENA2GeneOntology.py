...
# pip install pandas numpy docker
...
# Test Run
# /Users/bigyambat/Desktop/GWENA2GeneOntology/code/GWENA2GeneOntology.py --gwena_enrichment_file /Users/bigyambat/Desktop/GWENA2GeneOntology/test_data/Enrichment_Complete.xlsx --output_directory /Users/bigyambat/Desktop/GWENA2GeneOntology/test_data/output_directory --metascape_download_location /Users/bigyambat/Desktop/GWENA2GeneOntology/msbio_v3.5.20240901
...
class GWENAAnalysis:
    ...
    def__init__(self, input_file: str, output_dir: str, metascape_location: str):
    ...
    def create_gene_list(self, sample_sheet: pd.DataFrame) -> List[Path]:
        ...
        try:
            for i in sample_sheet['module'].unique():
    ...
    def run_metascape_analysis(self, module_file: Path) -> None:
        ...
        try:
            ...
            output_path = self.output_dir / "metascape" / module_file.stem
